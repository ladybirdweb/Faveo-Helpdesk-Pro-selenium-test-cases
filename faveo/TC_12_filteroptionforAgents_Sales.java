...
public class TC_12_filteroptionforAgents_Sales extends  Login_faveo_admin{
	@Test
...
//to click on agents
	...
	driver.findElement(By.xpath(".//*[@id='department-filter']/li[2]/a")).click();//all dept
	Thread.sleep(5000);
	 File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);//screenshot
		// Now you can do whatever you need to do with it, for example copy somewhere
		FileUtils.copyFile(scrFile, new File("c:\\Users\\yari\\git\\laxmi\\Screenshots\\12.png"));
