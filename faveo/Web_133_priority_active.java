...
public class Web_133_priority_active extends Login_faveo_admin {	@Test(priority=1)
...
try{
	...
	Thread.sleep(10000);
	//in active
	driver.findElement(By.xpath("html/body/div[1]/div/section[2]/form/div/div[2]/div/div[2]/div[2]/div/input[2]")).click();
	Thread.sleep(10000);
	//update
