...
public class Web_42_dept_search_support extends Login_faveo_admin {
	@Test
	...
	Thread.sleep(4000);
	driver.findElement(By.xpath(".//*[@id='chumper_filter']/label/input")).sendKeys("support");//department
	Thread.sleep(4000);
