...
public class TC_10_filteroptionforAgents_Alldepartments  extends  Login_faveo_admin{
	@Test
...
//to click on agents
	...
	Thread.sleep(5000);
	driver.findElement(By.xpath("//a[.='All departments']")).click();//all dept
	Thread.sleep(5000);
	 File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);//screenshot
		// Now you can do whatever you need to do with it, for example copy somewhere
		FileUtils.copyFile(scrFile, new File("c:\\Users\\yari\\git\\laxmi\\Screenshots\\10.png"));
